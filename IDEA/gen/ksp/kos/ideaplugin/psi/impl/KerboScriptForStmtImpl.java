...
public class KerboScriptForStmtImpl extends ASTWrapperPsiElement implements KerboScriptForStmt {

  public KerboScriptForStmtImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof KerboScriptVisitor) ((KerboScriptVisitor)visitor).visitForStmt(this);
