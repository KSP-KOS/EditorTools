...
public class KerboScriptUntilStmtImpl extends ASTWrapperPsiElement implements KerboScriptUntilStmt {

  public KerboScriptUntilStmtImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof KerboScriptVisitor) ((KerboScriptVisitor)visitor).visitUntilStmt(this);
