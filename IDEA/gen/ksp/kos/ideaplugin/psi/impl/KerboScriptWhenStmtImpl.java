...
public class KerboScriptWhenStmtImpl extends ASTWrapperPsiElement implements KerboScriptWhenStmt {

  public KerboScriptWhenStmtImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof KerboScriptVisitor) ((KerboScriptVisitor)visitor).visitWhenStmt(this);
