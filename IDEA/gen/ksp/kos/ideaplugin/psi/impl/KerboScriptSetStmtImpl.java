...
public class KerboScriptSetStmtImpl extends ASTWrapperPsiElement implements KerboScriptSetStmt {

  public KerboScriptSetStmtImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof KerboScriptVisitor) ((KerboScriptVisitor)visitor).visitSetStmt(this);
